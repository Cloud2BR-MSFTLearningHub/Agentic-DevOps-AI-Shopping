...
from .agent_adapters import (
    InteriorDesignAgentAdapter, InventoryAgentAdapter, CustomerLoyaltyAgentAdapter,
...
class A2ACoordinatorAgent(BaseAgentExecutor):
    ...
    def __init__(self):
        ...
        self.agents: Dict[str, BaseAgentExecutor] = {
            "interior_design": InteriorDesignAgentAdapter(),
            "inventory": InventoryAgentAdapter(), 
            "customer_loyalty": CustomerLoyaltyAgentAdapter(),
            "cart_management": CartManagementAgentAdapter(),
            "cora": CoraAgentAdapter()
        }
